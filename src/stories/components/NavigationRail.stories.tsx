...
const Logo = () => (
  <svg viewBox="0 0 120 16" height="16" aria-label="kubo.financiero">
    <rect x="0" y="2" width="12" height="12" rx="2" fill="var(--semantic-color-icon-brand)" />
    <text x="18" y="12" fontSize="12" fontWeight="700" fill="currentColor">kubo</text>
    <text x="52" y="12" fontSize="12" fill="var(--semantic-color-text-secondary)">.financiero</text>
  </svg>
);
